...
const footerData = [
  {
    ...
    title: "Need Help",
    links: [
      { text: "Contact Us", url: "/account" },
      { text: "Track Order", url: "/account" },
      { text: "Returns & Refunds", url: "/account" },
      { text: "FAQ's", url: "/account" },
      { text: "Career", url: "/account" },
    ],
  },
  {
    id: "f_company",
    title: "Company",
    links: [
      { text: "About Us", url: "/account" },
      { text: "Achats Blog", url: "/account" },
      { text: "Achatsian", url: "/account" },
      { text: "Collaboration", url: "/account" },
      { text: "Media", url: "/account" },
    ],
  },
  {
    id: "f_more_info",
    title: "More info",
    links: [
      { text: "Terms and conditions", url: "/account" },
      { text: "Privacy Policy", url: "/account" },
      { text: "Shipping Policy", url: "/account" },
      { text: "Sitemap", url: "/account" },
    ],
  },
  {
    id: "f_location",
